...
# Initial value
x0 = np.loadtxt(f'{os.path.dirname(__file__)}/data/xbase_3D.dat')
M0 = np.loadtxt(f'{os.path.dirname(__file__)}/data/Mbase_3D.dat')
rho0 = np.loadtxt(f'{os.path.dirname(__file__)}/data/rhobase_3D.dat')
v0 = np.zeros((len(M0), 3))
for idim in range(3):
    v0[:,idim] = np.loadtxt(f'{os.path.dirname(__file__)}/data/vbase{idim}_3D.dat')

# Interpolation reference
xinterp = np.loadtxt(f'{os.path.dirname(__file__)}/data/xinterp_3D.dat')
Minterp_ref = np.loadtxt(f'{os.path.dirname(__file__)}/data/Minterp_3D.dat')
rhointerp_ref = np.loadtxt(f'{os.path.dirname(__file__)}/data/rhointerp_3D.dat')
vinterp_ref = np.zeros((len(Minterp_ref), 3))
for idim in range(3):
    vinterp_ref[:,idim] = np.loadtxt(f'{os.path.dirname(__file__)}/data/vinterp{idim}_3D.dat')
